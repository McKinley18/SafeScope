...
- Name: failure-flow.spec.ts >> Incomplete hazard does not create a finding card
- Location: tests/e2e/failure-flow.spec.ts:21:5
...
Call log:
  - waiting for getByText(/Add New/i)
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::8v6xg-1778558949824-557c78981aa0`"
