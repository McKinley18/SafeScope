...
- Name: inspect-records-smoke.spec.ts >> Inspect flow loads and core buttons are visible
- Location: tests/e2e/inspect-records-smoke.spec.ts:3:5
...
Locator: getByText('Inspect').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Inspect').first()
...
- link "http://localhost:8081/tabs/camera":
  - /url: /tabs/camera
- text: Go back •
- link "Sitemap":
  - /url: /_sitemap
