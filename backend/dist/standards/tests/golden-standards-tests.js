...
async function main() {
    ...
    const service = new standards_service_1.StandardsService(data_source_1.dataSource.getRepository(standard_entity_1.Standard), fakeFeedbackRepo);
    let pass = 0;
    for (const [name, expectedCitation, request] of testCases) {
...
//# sourceMappingURL=golden-standards-tests.js.map