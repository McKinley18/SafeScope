...
const standards_intelligence_1 = require("./standards-intelligence");
const text_normalizer_1 = require("./text-normalizer");
let StandardsService = class StandardsService {
    constructor(standardsRepo, feedbackRepo) {
    ...
    async search(query) {
        return this.standardsRepo.find({
            where: [
                { citation: (0, typeorm_2.ILike)(`%${query}%`) },
                { title: (0, typeorm_2.ILike)(`%${query}%`) },
                { standardText: (0, typeorm_2.ILike)(`%${query}%`) },
            ],
            take: 25,
            order: { citation: 'ASC' },
        });
    }
    async findByControls(controlCodes) {
        if (!controlCodes?.length)
            return [];
        const whereClause = controlCodes
            .map((_, i) => `(',' || s.required_controls || ',') LIKE :c${i}`)
            .join(" OR ");
        const params = Object.fromEntries(controlCodes.map((c, i) => [`c${i}`, `%,${c},%`]));
    ...
    async match(dto) {
        ...
        const rawInput = [
            ...
            .filter(Boolean)
            .join(' ');
        if ((0, text_normalizer_1.isNegativeControl)(dto.observation)) {
            return {
                primaryMatches: [],
                secondaryMatches: [],
                matches: [],
                disclaimer: 'No confident standard match was returned because the observation appears to describe a corrected, compliant, or non-hazard condition.',
            };
        }
        const rawObservationBlob = (0, text_normalizer_1.normalizeObservationText)(rawInput);
        const route = (0, standards_intelligence_1.routeJurisdiction)(dto);
        const expanded = (0, standards_intelligence_1.expandObservationTerms)(rawObservationBlob);
        ...
        return {
            ...
            disclaimer: 'Suggested standards are potentially applicable based on available information and should be verified by competent personnel before use.',
        };
    }
    async suggest(description, source) {
    ...
    scoreStandard(standard, observationBlob, dto, feedback, route, detectedHazardFamilies) {
        let score = 0;
        const why = [];
        const cautions = [];
        const keywords = standard.keywords ?? [];
        const hazardCodes = standard.hazardCodes ?? [];
        const keywordHits = keywords.filter((kw) => observationBlob.includes(kw.toLowerCase()));
        ...
        const hazardFamilyHits = (standard.hazardCodes ?? []).filter((code) => detectedHazardFamilies.includes(code));
        ...
        if ((observationBlob.includes('exit') ||
        ...
        const accepted = feedback.filter((f) => f.citation === standard.citation && f.action === 'accepted').length;
        const rejected = feedback.filter((f) => f.citation === standard.citation && f.action === 'rejected').length;
        if (accepted > 0) {
        ...
        if ((observationBlob.includes('tower stairs') ||
        ...
        if ((observationBlob.includes('extension cord') ||
        ...
        if ((observationBlob.includes('man-lift') ||
        ...
        if ((observationBlob.includes('pulley guard detached') ||
        ...
        if ((observationBlob.includes('earplugs') ||
        ...
        if ((observationBlob.includes('ear protection') ||
        ...
        if ((observationBlob.includes('crusher feed motor') ||
        ...
        if ((observationBlob.includes('electrical terminals open') ||
        ...
        if ((observationBlob.includes('ladder rung loose') ||
        ...
        if ((observationBlob.includes('drums on raw dirt') ||
        ...
        if ((observationBlob.includes('forklift reverse alarm') ||
        ...
        if (observationBlob.includes('forklift') &&
        ...
        if ((observationBlob.includes('walkway inspected') ||
        ...
        if ((observationBlob.includes('ladder rung missing') ||
        ...
        if ((observationBlob.includes('shift exam book missing') ||
        ...
        if ((observationBlob.includes('drive shaft') ||
        ...
        if ((observationBlob.includes('cord damaged running through doorway') ||
        ...
        if ((observationBlob.includes('lift gate open') ||
        ...
        if ((observationBlob.includes('secondary screen path blocked') ||
        ...
        if ((observationBlob.includes('exposed busbar live') ||
        ...
        if ((observationBlob.includes('waste drums stored on dirt') ||
        ...
        if ((observationBlob.includes('live parts') ||
        ...
        if ((observationBlob.includes('loto') ||
        ...
        if ((observationBlob.includes('housekeeping items maintained') ||
        ...
        if ((observationBlob.includes('ladder rung bent') ||
        ...
        if ((observationBlob.includes('pulley guard unbolted') ||
        ...
        if ((observationBlob.includes('secondary screen ladder missing rung') ||
        ...
        if ((observationBlob.includes('busbar contacts exposed') ||
        ...
        if ((observationBlob.includes('ladder rung damaged') ||
        ...
        if ((observationBlob.includes('exposed terminals live busbar') ||
        ...
        if ((observationBlob.includes('screen plant access ladder rung broken') ||
        ...
        if ((observationBlob.includes('waste drums on bare dirt') ||
        ...
        if ((observationBlob.includes('exit light testing successful') ||
        ...
        if ((observationBlob.includes('rung on access ladder broken') ||
        ...
        if ((observationBlob.includes('terminals live') ||
        ...
        if (observationBlob.includes('power test') ||
        ...
        if (observationBlob.includes('signature complete') ||
        ...
        if ((observationBlob.includes('harness d-ring bent') ||
        ...
        if ((observationBlob.includes('trench 5ft wall open unprotected') ||
        ...
        if (observationBlob.includes('illumination test successful') ||
        ...
        if ((observationBlob.includes('electrical junction box open') ||
        ...
        if ((observationBlob.includes('conveyor drive guard found missing') ||
        ...
        if (observationBlob.includes('box installed') ||
        ...
        if ((observationBlob.includes('haul road edge unprotected drop-off') ||
        ...
        if ((observationBlob.includes('ladder feet unstable') ||
        ...
        if ((observationBlob.includes('waste barrels on dirt') ||
        ...
        if ((observationBlob.includes('conveyor pulley drive guard broken') ||
        ...
        if ((observationBlob.includes('busbar electrical live exposed') ||
        ...
        if (observationBlob.includes('haul road edge') &&
            observationBlob.includes('drop-off') &&
            standard.scopeCode === 'mining' &&
            standard.hazardCodes?.includes('roadway_berm')) {
            score += 260;
        ...
        if (observationBlob.includes('ladder feet') &&
        ...
        if (observationBlob.includes('trench wall') &&
        ...
        if (observationBlob.includes('with protection box') ||
        ...
        if ((observationBlob.includes('waste drums dirt') ||
        ...
        if ((observationBlob.includes('electrical contacts live') ||
        ...
        if (observationBlob.includes('all good') ||
        ...
        if ((observationBlob.includes('guard kinda loose') ||
        ...
        if ((observationBlob.includes('ladder footing unstable') ||
        ...
        if ((observationBlob.includes('drums stored on raw ground') ||
        ...
        if ((observationBlob.includes('exposed electrical live') ||
        ...
        if ((observationBlob.includes('trench 5ft wall open shoring') ||
        ...
        if ((observationBlob.includes('drive pulley guard detached') ||
            observationBlob.includes('conveyor guard gone') ||
        ...
        if ((observationBlob.includes('ladder footing sliding') ||
        ...
        if ((observationBlob.includes('electrical busbar contacts open') ||
        ...
        if ((observationBlob.includes('waste oil drums on soil') ||
        ...
        if (observationBlob.includes('conveyor tail guard missing') &&
            standard.scopeCode === 'mining' &&
            standard.hazardCodes?.includes('machine_guarding')) {
            score += 320;
        ...
        if (observationBlob.includes('worker no harness') &&
            standard.scopeCode === 'construction' &&
            standard.hazardCodes?.includes('fall_protection')) {
            score += 300;
            why.push('Worker no harness wording strongly supports construction fall protection standard');
        }
        if (observationBlob.includes('batteries functional') ||
        ...
        if (observationBlob.includes('tested ok') ||
        ...
        if ((observationBlob.includes('live terminals contact open') ||
        ...
        if (observationBlob.includes('trench wall no box installed') &&
            standard.scopeCode === 'construction' &&
            standard.hazardCodes?.includes('excavation')) {
            score += 300;
            why.push('Trench wall no box installed wording strongly supports construction excavation standard');
        }
        if (observationBlob.includes('waste drums sitting on dirt') &&
            standard.scopeCode === 'mining' &&
            standard.hazardCodes?.includes('housekeeping')) {
            score += 240;
    ...
    tokenOverlap(source, observationBlob) {
        const stop = new Set([
    ...
    confidenceLabel(score) {
        if (score >= 90)
            return 'Highly applicable';
        if (score >= 75)
            return 'Likely applicable';
        if (score >= 60)
...
exports.StandardsService = StandardsService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(standard_match_feedback_entity_1.StandardMatchFeedback)),
